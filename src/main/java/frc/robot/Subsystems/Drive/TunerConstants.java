...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(1).withKI(0).withKD(0).withKS(0.06241).withKV(.30278);
  ...
  private static final Distance kWheelRadius = Inches.of(1.931);
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.43310546875);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.388427734375);
